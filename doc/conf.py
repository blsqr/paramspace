...
def run_apidoc(_):
    ...
    module = os.path.join(cur_dir, "..", "paramspace")
...
project = "paramspace"
copyright = "2017 - 2023, Yunus Sevinchan"
...
# Title, Logo, Favicon
#
html_title = "paramspace docs"
html_logo = "_static/img/hypercube_pd.svg"
html_favicon = "_static/img/hypercube_pd_480.png"

# -- Options for HTMLHelp output ---------------------------------------------

# Output file base name for HTML help builder.
htmlhelp_basename = "paramspace_doc"
...
man_pages = [
    (master_doc, "paramspace", "paramspace Documentation", [author], 1)
]
